...
class AmazonReviewsSpider(scrapy.Spider):
    ...
    os.system("rm ~/SE_Project1/sentimental_analysis/realworld/reviews.json")
    my_file_handle = open('~/SE_Project1/sentimental_analysis/realworld/ProductAnalysis.txt')

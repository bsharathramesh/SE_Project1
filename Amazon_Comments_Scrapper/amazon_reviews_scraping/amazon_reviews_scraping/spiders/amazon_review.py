...
class AmazonReviewsSpider(scrapy.Spider):
    ...
    os.system("rm /Users/nischalkashyap/Downloads/Projects/SE_Project1/sentimental_analysis/reviews.json")
    my_file_handle = open(
        '/Users/nischalkashyap/Downloads/Projects/SE_Project1/Amazon_Comments_Scrapper/amazon_reviews_scraping/amazon_reviews_scraping/spiders/ProductAnalysis.txt')
